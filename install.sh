...
resolve_snapshot_version() {
    snapshot_api_url="https://api.github.com/repos/allen0039/komari_agent/releases?per_page=100"
...
if [ -n "$panel_endpoint" ]; then
    ...
    if [ -n "$github_proxy" ]; then
        download_url="${github_proxy}/https://github.com/allen0039/komari_agent/releases/${download_path}/${file_name}"
    else
        download_url="https://github.com/allen0039/komari_agent/releases/${download_path}/${file_name}"
    fi
fi
